...
public class ExampleMod
{
    ...
    public static class RegistryEvents {
        ...
        public static void setup(FMLCommonSetupEvent event) {
            ORE_SILVER_CONFIG = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, "ore_red",
                    Feature.ORE.withConfiguration(
                            new OreFeatureConfig(
                                    OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD,
                                    ModBlocks.RED_ORE.get().getDefaultState(), 9)
        ...
        public void onBiomeLoading(final BiomeLoadingEvent biome) {
            ...
            biome.getGeneration().getFeatures(GenerationStage.Decoration.UNDERGROUND_ORES)
                    .add(() -> RegistryEvents.ORE_SILVER_CONFIG);
        }
